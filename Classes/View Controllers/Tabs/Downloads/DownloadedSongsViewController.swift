...
final class DownloadedSongsViewController: AbstractDownloadsViewController {
    ...
    override func reloadTable() {
        downloadedSongs = settings.isCombinedContext ? store.downloadedSongs() : store.downloadedSongs(serverId: serverId)
        super.reloadTable()
...
extension DownloadedSongsViewController {
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        if !isEditing, let song = playbackCoordinator.play(downloadedSongs: downloadedSongs, position: indexPath.row), !song.isVideo {
