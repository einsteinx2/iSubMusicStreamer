...
final class AppServices {
    ...
    init() {
        ...
        offlineModeCoordinator = OfflineModeCoordinator(settings: settings, session: session, networkStatus: networkMonitor, playbackCoordinator: playbackCoordinator, analytics: analytics)
