...
final class AppServices {
    ...
    init() {
        ...
        serverSwitcher = ServerSwitcher(streamManager: downloadEngine.streamManager, player: player, settings: settings, session: session, store: store, stateRestorer: stateRestorer)
