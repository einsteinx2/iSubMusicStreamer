...
- [ ] **[TEST-02] P0 — Add in-memory/temp database support to the Store layer.** `Store.swift:23-44` hardcodes a `DatabasePool` at `ApplicationSupport/iSub/database/iSub.db`.
